...
public class WorldChunkManagerHeightmap extends WorldChunkManager {
    ...
    public WorldChunkManagerHeightmap(long seed, WorldType worldType, WorldHeightmapGenerator generator) {
        this(generator);
    ...
    public WorldChunkManagerHeightmap(World world, WorldHeightmapGenerator generator) {
