...
public class GuiModUpdates extends GuiScreen {
    ...
    public void initGui() {
        ...
        search = new GuiTextField(fontRendererObj, 12, modList.getBottom() + 17, modList.getListWidth() - 4, 14);
        ...
        int x = 10, y = 10;
        int buttonMargin = 1;
        GuiButton normalSort = new GuiButton(SortType.NORMAL.buttonID, x, y, width - buttonMargin, 20, I18n.format("Normal"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (VersionHandler.getOutdatedMods().isEmpty()) {
            ...
            String text = I18n.format("Search");
    ...
    private class Info extends GuiScrollingList {
        ...
        public Info(int width, List<String> lines) {
            super(GuiModUpdates.this.mc, width, GuiModUpdates.this.height, 32, GuiModUpdates.this.height - 77 + 4, GuiModUpdates.this.listWidth + 20, 60);
