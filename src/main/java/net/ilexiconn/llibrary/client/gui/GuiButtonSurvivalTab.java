...
public class GuiButtonSurvivalTab extends GuiButton
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (visible)
        {
            ...
            mc.getRenderItem().renderItemAndEffectIntoGUI(survivalTab.getIcon(), xPosition + 6, yPosition + 8);
            mc.getRenderItem().renderItemOverlayIntoGUI(mc.fontRendererObj, survivalTab.getIcon(), xPosition + 6, yPosition + 8, null);
