...
public class WavefrontObject implements IModelCustom {
    ...
    public ArrayList<Vertex> vertices = Lists.newArrayList();
    public ArrayList<Vertex> vertexNormals = Lists.newArrayList();
    public ArrayList<TextureCoordinate> textureCoordinates = Lists.newArrayList();
    public ArrayList<GroupObject> groupObjects = Lists.newArrayList();
